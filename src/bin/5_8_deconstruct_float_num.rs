...
fn main() {
    ...
    let reconstitudeted_n = f32_from_parts(sign, exponent, mantissa);

    println!(
        "{} -> [sign: {}, exponent: {}, mantissa: {:?}] -> {}",
        n, signbit, exponent, mantissa, reconstitudeted_n
    );
}
...
fn deconstruct_f32(n: f32) -> (u32, u32, u32) {
    ...
    let fraction = 0b00000000_011111111_11111111_11111111 & n_;
